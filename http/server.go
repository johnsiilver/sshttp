...
var (
	...
	// ErrIngore indicates that the net.Listener.Accept() wants to ignore this connection.
	ErrIgnore = errors.New("the listener told the server to ignore this connection")
)
...
func (srv *Server) onceSetNextProtoDefaults() {
	if omitBundledHTTP2 || godebugGet("http2server") == "0" {
		return
	}
